...
function printStyle() {
	...
	res += '  .thang {font-size: '+fontSize+'; padding:1; line-height:100%; font-family:Tahoma,Verdana,Arial; table-layout:fixed; width:301px;}\n';
	...
	res += '  .ngaytuan {width:14%; text-align:center; font-size:100%; line-height:30px; color:#330033; background-color: #FFFFCC}\n';
...
function printCell(lunarDate, solarDate, solarMonth, solarYear) {
	...
	args += ("," + lunarDate.jd + "," + solarDate + "," + solarMonth + "," + solarYear);		var nguyenlan = lunarDate.day + "," + lunarDate.month + "," + lunarDate.year + "," + lunarDate.leap;	nguyenlan += ("," + lunarDate.jd + "," + solarDate + "," + solarMonth + "," + solarYear);		
	res += ('<td class="'+cellClass+'"');
	if (lunarDate != null) res += (' title="'+getDayName(lunarDate)+'" onmouseover="lichshow('+nguyenlan+');" onmouseout="hidetip();" onClick="alertDayInfo('+args+');"');
...
}function lichshow(ngayam,thangam,namam,leapp,jdd,ngayduong,thangduong,namduong) {	if (ns6 || ie) {		tipobj.innerHTML = '<div class="lich_vn"><div class="lich_t_t lich_ft">Tháng '+thangduong+' năm '+namduong+'</div><div class="lich_fn">'+ngayduong+'</div><div class="lich_fa">Âm lịch ngày :<strong>'+ngayam+'</strong> tháng <strong>'+thangam+'</strong>  </div><div class="lich_ftu">NAM MÔ BỔN SƯ THÍCH CA MÂU NI PHẬT</div></div>';				enabletip = true;		return false;	}	}
