...
?>
<li class="menu-item"><a href="<?php echo $BASE_URL; ?>"><?php echo __('LABEL_HOME');?></a></li>
<?php if (!empty($cates)): ?>
    ...
    <?php endforeach; ?>
<?php endif; ?>
<li class="menu-item"><a href="<?php echo $BASE_URL; ?>/lien-he"><?php echo __('LABEL_CONTACT');?></a></li>
